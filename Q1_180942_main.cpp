...
#include "Q1_180942_bankAccount.h"
#include <string>
#include <fstream>
using namespace std;
...
//
////.... readFile(....); 
bankAccount** readFile(int &);
////....printAccounts(....);
void printAccounts(bankAccount **, int);
////bool makeTransaction(....);
bool makeTransactions(bankAccount**,int, int, float, bool);
////void deleteAccounts(....);
void deleteAccounts(bankAccount**,int);
//
void main()
//
{
...
//	Assign a new object to 2nt pointer in array with ID= 40, balance=255000, balanceLimit=400000 ~1 line
//	print both the objects ~ 2 line
//	*/
//	//*****Write your code here

	bankAccount *b2[2];
	float transactions1[]={3000,5000,60000};
	b2[0]=new bankAccount(30,2000,transactions1,3);
...
//	*/
	...
	float tracsactions2[]={-5000,5000};
	b3[0]=new bankAccount(50,2000,tracsactions2,2);
...
//
////.... readFile(....){}
bankAccount ** readFile(int &arrSize)
	{
		bankAccount **b6;
		...
		if (fin.is_open())
		{
			...
			for (int i=0; i<arrSize; i++)
			{
				...
				if (n>0)
				{
					...
					b6[i]=new bankAccount(i,b,temp,n,l);
				}
				else
					b6[i]=new bankAccount(i,b,l);
				delete[] temp;
			 }
			return b6;
		 }
...
////bool makeTransaction(....){}
bool makeTransactions(bankAccount**arr,int size, int i, float a, bool t)
{
	bool done=false;
	for (int i=0; i<size; i++)
	{
